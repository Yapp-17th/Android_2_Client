...
import com.yapp.data.request.board.BookMarkRequest
import com.yapp.data.request.board.PostBoardIdRequest
import com.yapp.data.request.board.PostBoardRequest
...
import com.yapp.data.response.chatting.CommonServerResponse
import com.yapp.data.response.chatting.MakeChattingRoomResponse
...
interface Api {
    ...
    fun getExercise(): Single<com.yapp.data.response.basic.ExerciseResponse>
